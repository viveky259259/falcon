...
fn built_in_registry() -> Vec<RegistryEntry> {
    vec![
        RegistryEntry {
            ...
            description:
                "Rules for flutter_hooks package — lifecycle and state management best practices."
                    .to_string(),
        ...
        RegistryEntry {
            ...
            description: "Enforce clean architecture boundaries with custom layer rules."
                .to_string(),
            author: "Falcon Community".to_string(),
            downloads: 3400,
            rating: 4.9,
        ...
        RegistryEntry {
            ...
            description:
                "Rules for freezed package — data class conventions and union type patterns."
                    .to_string(),
            author: "Falcon Community".to_string(),
            downloads: 890,
            rating: 4.5,
        ...
        RegistryEntry {
            ...
            version: "1.0.0".to_string(),
            description:
                "Firebase SDK best practices — security rules, query patterns, offline handling."
                    .to_string(),
            author: "Falcon Community".to_string(),
            downloads: 2100,
            rating: 4.6,
        ...
        RegistryEntry {
            ...
            description:
                "GetX state management rules — controller patterns, reactive variables, routing."
                    .to_string(),
            author: "Falcon Community".to_string(),
            downloads: 670,
            rating: 4.2,
        ...
        RegistryEntry {
            ...
            description:
                "A11y rules — semantics, contrast ratios, touch target sizes, screen reader hints."
                    .to_string(),
            author: "Falcon Community".to_string(),
            downloads: 1800,
            rating: 4.8,
...
pub fn print_search_results(results: &[RegistryEntry], query: &str) {
    ...
    for entry in results {
        ...
        println!("    tags: {}", entry.tags.join(", ").bright_blue());
